...
The v0.7 thirty-day life simulation remains a mandatory regression gate. v0.8 does not replace relationship development, epistemic integrity, homeostatic recovery, adaptive action learning, or first-person reinterpretation. It adds a new temporal dimension: the same continuing subject can now be organized partly by things it has not finished yet.
