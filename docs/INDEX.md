...
`ARCHITECTURE_v0.6.md` and `MILESTONE_0_6.md` remain preserved as the first longitudinally regulated whole-organism baseline.

`ARCHITECTURE_v0.5.md` and `MILESTONE_0_5.md` remain preserved as the first whole-organism FrankenDUCK integration.

`ARCHITECTURE_v0.1.md` and `MILESTONE_0_1.md` remain preserved as the original Subjective Moment milestone. Historical documents should not be silently rewritten to describe later architecture.
